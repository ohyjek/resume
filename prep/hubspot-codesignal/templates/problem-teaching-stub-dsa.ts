...
export type <FUNCTION_NAME_PASCAL>Input = unknown;
export type <FUNCTION_NAME_PASCAL>Output = unknown;
 ...
 */
export function <FUNCTION_NAME>(input: <FUNCTION_NAME_PASCAL>Input): <FUNCTION_NAME_PASCAL>Output {
